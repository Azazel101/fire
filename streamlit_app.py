...
st.write("2. You would need a princle of about", principle, "to have an annual income of", amount_1," interest yearly or ", round(amount_1 / 12,1) ," monthly from your principle.")
